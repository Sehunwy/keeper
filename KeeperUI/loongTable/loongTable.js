...
(function($) {
    $.fn.loongTable1 = function (options) {
        var config = $.extend({
            height: "auto",
            fields: [],
            hasCheckbox: true,
        ...
        var $container = $(this);
        var loongTable1 = new LoongTable1();
        loongTable1.init($container, config);
        return loongTable1;
    };

    function LoongTable1() {
        this.checkedIndex = [];
        this.rowData = [];
        this.totalNum = 0;
        this.curPage = 1;
    ...
    LoongTable1.prototype = {
        ...
        listData: function ($container, config, data) {
            ...
            if ( data == undefined || data.length == 0) {
                ...
                noData.src = "/LoongUI/frame/lib/loongTable/img/noData.png";
        ...
        addLoading:function($container,img){
            var img = new Image();
            img.src = "/LoongUI/frame/lib/loongTable/img/loading.gif";
    ...
    LoongTable1.prototype.setCheck = function (td) {
        this.rowClickFn(this.$container,this.config,$(td));
    };

    LoongTable1.prototype.getCheckedIndex = function () {

        return this.checkedIndex.sort();
    };
    LoongTable1.prototype.getRowData = function (index) {
        if (undefined == index) {
    ...
    LoongTable1.prototype.getCurrentPage = function () {

        return this.curPage;
    };

    LoongTable1.prototype.refresh = function (id, arr) {
        var self = this;
    ...
    LoongTable1.prototype.remianFresh = function(key){
